<%@ Page Title="Ürün Kayit" Language="C#" MasterPageFile="~/Applctn/Site.master" AutoEventWireup="true"
    CodeFile="Urun_Kayit.aspx.cs" Inherits="_Default" %>
...
<br />
 ...
 <asp:Label ID="Lbl_Baslik" runat="server"><h2>ÜRÜN KAYIT</h2></asp:Label>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
...
<asp:MaskedEditExtender
    ...
    InputDirection="RightToLeft" 
    AcceptNegative="None"    
    ErrorTooltipEnabled="True" runat="server" DisplayMoney="None" CultureName="tr-TR" />
 <asp:DropDownList ID="DDL_ind_fiy_dvz" runat="server" Width="60">
  ...
  <asp:ImageButton
     ...
     InvalidValueMessage="İndirim bitiş tarihi formatı geçerli değil." ValidationGroup="Validation_urunkayit_Group" >*</asp:MaskedEditValidator>
 </asp:TableCell>
 </asp:TableRow>
 <asp:TableRow>
 <asp:TableCell>
...
<%--  <asp:TableRow>
 ...
 <asp:FileUpload ID="FileUpl_urunresim" runat="server" Width="400"/>
    <asp:RequiredFieldValidator ID="FileUpl_urunresimRequired" runat="server" ControlToValidate="FileUpl_urunresim" 
                             CssClass="failureNotification" ErrorMessage="Ürün resimi gerekli." ToolTip="Ürün resimi gerekli." 
                             ValidationGroup="Validation_urunkayit_Group">*</asp:RequiredFieldValidator>&nbsp;                             
