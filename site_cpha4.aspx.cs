...
public partial class site_cpha4 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            for (x = 0; x < 8; x++)
            {
                ...
                randomsitecphaStr += (mystrArray[x].ToString());
            }
            //This is to add the string to session cookie, to be compared later
            Session.Add("randomsitecphaStr", randomsitecphaStr);
            //' Write out the text
            objGraphics.DrawString(randomsitecphaStr, objFont, Brushes.White, 20, -2);
